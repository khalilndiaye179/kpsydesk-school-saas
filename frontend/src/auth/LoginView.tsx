  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: '#050a15', fontFamily: 'var(--font-main)' }}>
      ...
      <div style={{ 
        ...
        {floatingModules.map((mod, idx) => (
          <div key={idx} style={{
            ...
            <div style={{
              ...
              border: '1px solid rgba(255, 255, 255, 0.2)', borderRadius: '20px', padding: '16px', color: 'white',
        ...
        {/* Informations KPSy Informatique */}
      ...
      {/* RIGHT SECTION - Panel de Connexion Séquentiel Strict */}
      <div style={{ 
        flex: '3', minWidth: '400px', maxWidth: '500px', backgroundColor: '#0a0f1c',
        display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: '40px'
      }}>
        
        {/* Glass Panel */}
        <div style={{
          width: '100%', backgroundColor: 'rgba(255, 255, 255, 0.03)', backdropFilter: 'blur(20px)',
          borderRadius: '24px', border: '1px solid rgba(255, 255, 255, 0.1)', padding: '40px 32px',
          boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.5)', marginBottom: '32px'
        }}>
          ...
          {/* RENDU SÉQUENTIEL STRICT DU COMPOSANT :
              1. Si challengeId est nul : Afficher le composant PasswordStep (Email + Password).
              2. Si challengeId est retourné par le serveur : Afficher le composant OtpStep (Code 6 chiffres).
              L'OTP N'EST JAMAIS PRÉSENT DANS LE DOM AVANT LA RÉPONSE DU SERVEUR.
          */}
          {!challengeId ? (
            <PasswordStep 
        ...
        <div style={{ textAlign: 'center', color: '#94a3b8', fontSize: '0.75rem', width: '100%' }}>
          <p style={{ margin: '0 0 4px 0' }}>Établissement Démo / SaaS Multi-Tenant</p>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', lineHeight: 1.6 }}>
              ...
              <div>
                ...
                <p style={{ margin: 0 }}>Chaque organisation cliente dispose d'un espace de données strictly cloisonné. Aucune entreprise abonnée ne peut accéder, même partiellement, aux données d'une autre — cette isolation est appliquée au niveau technique de notre infrastructure, pas seulement au niveau de l'interface.</p>
              </div>
            </div>
