        ...
        setPlans([
          {
            ...
            maxStudents: 350,
            annualDiscount: 0,
            description: 'Le plan idéal pour commencer.',
            features: ['Gestion Scolaire de base', 'Support par email'],
            tags: 'Basic',
            recommended: false
          },
          {
            ...
            maxStudents: 750,
            annualDiscount: 10,
            description: 'Pour les écoles en pleine croissance.',
            features: ['Gestion Scolaire de base', 'Module Financier', 'Kiosque Pointage'],
            tags: 'Pro, Recommandé',
            recommended: true
          },
          {
            ...
            maxStudents: 99999,
            annualDiscount: 15,
            description: 'La suite complète avec serveur dédié.',
            features: ['Gestion Scolaire de base', 'Module Financier', 'Kiosque Pointage', 'Espace RH', 'Multi-campus'],
            tags: 'Enterprise, Illimité',
            recommended: false
          }
        ]);
      }
